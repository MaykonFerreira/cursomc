...
public class SwaggerConfig {
	...
	// Personalização de Retorno do swagger
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				// Desabilita as respostas Padrões
				.useDefaultResponseMessages(false)
				// Resposta Personalizadas
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Maykon Ferreira", "https://github.com/MaykonFerreira", "lmaykonf@gmail.com"),
				"Permitido uso para Empresas", "https://www.udemy.com/terms", Collections.emptyList() // Vendor
																										// Extensions
		);
	}
